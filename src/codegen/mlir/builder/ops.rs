    ...
    'ctx: 'a,
{
    ...
    let result_op = match op {
        ...
        BinOp::Eq => arith::cmpi(ctx.context, CmpiPredicate::Eq, lhs, rhs, location),
        BinOp::Lt => arith::cmpi(ctx.context, CmpiPredicate::Slt, lhs, rhs, location),
        BinOp::Le => arith::cmpi(ctx.context, CmpiPredicate::Sle, lhs, rhs, location),
        BinOp::Gt => arith::cmpi(ctx.context, CmpiPredicate::Sgt, lhs, rhs, location),
        BinOp::Ge => arith::cmpi(ctx.context, CmpiPredicate::Sge, lhs, rhs, location),
        BinOp::Neq => arith::cmpi(ctx.context, CmpiPredicate::Ne, lhs, rhs, location),
